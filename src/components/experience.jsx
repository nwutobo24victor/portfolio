    ...
    return (
        ...
        <div className="block">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    <div class="absolute left-[-10px] top-2 w-4 h-4 bg-[#27ce80] rounded-full"></div>
                    <div>
                        <h3 class="text-xl font-semibold ">Full Stack Web Developer</h3>
                        <p class="text-sm text-[#27ce80]">Ichie ICT, Enugu</p>
                    </div>
                ...
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[#27ce80]">Man O' War Nigeria – National Headquarters, Abuja</p>
                    </div>
                ...
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[#27ce80]">Man O' War Nigeria, Abuja</p>
                    </div>
                ...
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[#27ce80]">Kings Guards Nigeria Ltd, Canaan Land Ota</p>
                    </div>
                ...
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[#27ce80]">KJSG Cab Services, Ota, Ogun State</p>
                    </div>
                ...
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[#27ce80]">Napec Marshal Corp, Ibadan</p>
                    </div>
                ...
                <div class="md:flex md:justify-between md:items-start gap-4 border-l-4 border-[#27ce80] pl-6 relative">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[#27ce80]">Emjay Communication, Ota, Ogun State</p>
                    </div>
