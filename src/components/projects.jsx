                ...
                <div className="grid gap-12 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="http://manowarng.org" target="_blank" className="text-[#27ce80] font-medium hover:underline">Visit Website</a>
                        </div>
                    </article>
                    ...
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="https://github.com/nwutobo24victor/case_study_pos" target="_blank" className="text-[#27ce80] font-medium hover:underline">View Case Study</a>
                        </div>
                    </article>
                    ...
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="http://recruitment.manowarng.org" target="_blank" className="text-[#27ce80] font-medium hover:underline">Visit Website</a>
                        </div>
                    </article>
                    ...
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="http://dragsdev.com.ng" target="_blank" className="text-[#27ce80] font-medium hover:underline">View Website</a>
                        </div>
                    </article>
                    ...
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="https://stpaulsonline.ng/" target="_blank" className="text-[#27ce80] font-medium hover:underline">Visit Website</a>
                        </div>
                    </article>
                    ...
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="http://kjsgcab.icu" target="_blank" className="text-[#27ce80] font-medium hover:underline">Visit Website</a>
                        </div>
                    </article>
                    ...
                    <article className="bg-[#22274A50] rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-[#27ce80]/20" data-aos="flip-left">
                        ...
                        <div className="p-6">
                            ...
                            <a href="http://survey.manowarng.org" target="_blank" className="text-[#27ce80] font-medium hover:underline">Visit Website</a>
                        </div>
                    </article>
