                        ...
                        <div className="flex items-center col-span-1 bg-[#020013] p-2 rounded-lg mb-1" data-aos="fade-up">
                            <div className="block bg-[#3CAAFB] rounded-full p-2 mr-4">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" viewBox="0 0 24 24" >
                                        <path class="b" d="m20.5,16h-5.5v-1h4c1.1,0,2-.9,2-2V4c0-1.1-.9-2-2-2H5c-1.1,0-2,.9-2,2v9c0,1.1.9,2,2,2h4v1H3.5c-.83,0-1.5.67-1.5,1.5v3c0,.83.67,1.5,1.5,1.5h17c.83,0,1.5-.67,1.5-1.5v-3c0-.83-.67-1.5-1.5-1.5ZM5,4h14v9s-14,0-14,0V4Zm10,16H5v-2h10v2Zm3,0c-.55,0-1-.45-1-1s.45-1,1-1,1,.45,1,1-.45,1-1,1Z"></path>
                                    </svg>
                                </span>
                            </div>
                            <div className="block">
