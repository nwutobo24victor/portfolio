        ...
        <main className="w-full text-white bg-[#020013]">
            <div className=" lg:px-10 px-2 py-2">
                ...
                <section className="bg-[#27ce8030] rounded-lg p-3 w-full mb-10  flex items-center justify-center" data-aos="fade-up">
                    <header className="text-center w-full">
                        ...
                        <p className="text-lg text-center max-w-3xl mx-auto">
                            We’re here to assist you. Whether you have inquiries, projects, or need support, feel free to reach out to us. Our team is ready to respond and provide the best possible service.
                        </p>

                        <p className="text-lg text-left">
                            <a href="./" className="text-[#27ce80]">Home</a> / <span>Contact Us</span>
                        </p>
                    </header>
                ...
                <section className="w-full">
                    ...
                    <div className="flex lg:flex-row flex-col-reverse justify-center gap-6 w-full h-[calc(100vh - 400px)] p-4">
                        ...
                        <div className="block w-full lg:w-2/3 rounded-lg">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31717.44427048571!2d7.50467040575971!3d6.43506403758095!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1044a6aad0d2695f%3A0x260e4e41c5b07535!2sIndependence%20Layout%2C%20Enugu!5e0!3m2!1sen!2sng!4v1765397211186!5m2!1sen!2sng" className="w-full h-[400px] lg:h-full border-0 rounded-lg"   allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                        ...
                        <div className="block w-full lg:w-1/3 rounded-lg">
                            ...
                            <div className="hidden wflex items-center justify-center gap-4 my-4 text-white" data-aos="fade-up">
